-- Daily Practice Feature Migration
-- Creates tables for the Daily Practice feature
...
-- =============================================================================
-- 2. Update user_profiles table with Daily Practice fields
-- =============================================================================
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS last_completed_daily_practice_activity INTEGER DEFAULT 0;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS last_daily_practice_activity_completed_at TIMESTAMPTZ;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS total_score INTEGER DEFAULT 0;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS daily_practice_scores JSONB DEFAULT '{}'::jsonb;
...
-- =============================================================================
-- 3. Create daily_practice_results table (Analytics)
-- =============================================================================
...
-- =============================================================================
-- 4. Create or update updated_at trigger function
-- =============================================================================
