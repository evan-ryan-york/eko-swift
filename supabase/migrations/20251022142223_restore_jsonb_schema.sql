-- Restore JSONB schema for daily_practice_activities
-- This undoes the normalized schema and restores the single-table JSONB design from migration 20251020000000
...
-- =============================================================================
-- 1. Create daily_practice_activities table (JSONB schema)
-- =============================================================================
